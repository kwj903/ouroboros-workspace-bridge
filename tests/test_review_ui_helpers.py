...
class ReviewServerHelperTests(unittest.TestCase):
    ...
    def test_docs_describe_bundle_tool_workflow(self) -> None:
        ...
        self.assertIn("workspace_stage_command_bundle_and_wait", english)
        self.assertIn("workspace_stage_action_bundle_and_wait", english)
        ...
        self.assertIn("workspace_stage_command_bundle_and_wait", korean)
        self.assertIn("workspace_stage_action_bundle_and_wait", korean)
