...
class ReviewServerHelperTests(unittest.TestCase):
    ...
    def test_docs_describe_bundle_tool_workflow(self) -> None:
        ...
        self.assertIn("workspace_propose_command_and_wait", english)
        self.assertIn("workspace_propose_file_replace_and_wait", english)
        self.assertIn("workspace_propose_git_push_and_wait", english)
